...
@Service(value = "IncomeBudgetBizcsService")
public class IncomeBudgetBizcsServiceImpl extends BaseServiceImpl implements IncomeBudgetBizcsService {
	@Override
	public List getArea(String period, String profess, String branch,
	   ...
	   //拼接SQL   
		...
		sql.append(SqlPara.incomeBudgetBizcsMap) ;
	...
	public List getLine(String period, String profess, String branch,
		...
		StringBuffer sql = new StringBuffer("");
		sql.append(SqlPara.incomeBudgetBizcsLine) ;
