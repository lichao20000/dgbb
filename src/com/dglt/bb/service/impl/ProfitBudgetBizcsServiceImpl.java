...
@Service(value = "ProfitBudgetBizcsService")
public class ProfitBudgetBizcsServiceImpl extends BaseServiceImpl implements ProfitBudgetBizcsService {
	@Override
	public List getArea(String period, String profess, String branch,
	      String bizcs,String productCode,String client ) {
	   ...
	   //拼接SQL   
		...
		sql.append(SqlPara.profitBudgetBizcsMap) ;
		...
		String [] arry = SqlPara.arr1incomeBudgetBizcsMap ;
	...
	public List getLine(String period, String profess, String branch,
		...
		StringBuffer sql = new StringBuffer("");
		sql.append(SqlPara.profitBudgetBizcsLine) ;
        ...
        String [] arry = SqlPara.arr1profitBudgetBizcsLine ;
