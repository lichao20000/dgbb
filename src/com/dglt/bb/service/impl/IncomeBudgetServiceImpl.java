...
@Service(value = "IncomeBudgetService")
public class IncomeBudgetServiceImpl extends BaseServiceImpl implements IncomeBudgetService {
	...
	public List getArea(String period, String profess, String branch,
	   ...
	   //拼接SQL   
		...
		sql.append(SqlPara.incomeBudgetMap) ;
		...
		String [] arry = SqlPara.arrIncomeBudgetMap ;
	...
	public List getLine(String period, String profess, String branch,
		...
		StringBuffer sql = new StringBuffer("");
		sql.append(SqlPara.incomeBudgetLine) ;
        ...
        String [] arry = SqlPara.arrIncomeBudgetLine ;
		System.out.println(sql.toString());
	    List l = this.findByNativeQuery(sql.toString());
        //报表查询，返回数据不是持久化对象时，进行转换
