...
public class DataPageJQGrid implements DataPageIntf
{
	@SerializedName("pagesize")private int pageSize = 10; // 每页的记录数

	@SerializedName("start")private int start; // 当前页第一条数据在List中的位置,从0开始

	@SerializedName("invdata")private List data; // 当前页中存放的记录,类型一般为List

	@SerializedName("totalrecords")private int totalCount; // 总记录数
	
	@SerializedName("currpage")private int pageNo; // 当前页码
	
	@SerializedName("totalpages")private int totalPageCount; // 总页数
