...
//  对应 base64.js 文件的 decode(str) 函数
    ...
    public static void main(String args[])throws Exception{
            ...
            String e = encode("schoolid=152200001144,type=2,userid=20103,name=石老师,subject=2,audience=31,year=,classid=,phone=13580561100");
            System.out.println("ENCRYPT: " + e);
            String d = decode(e);
            System.out.println("DECRYPT: " + d);
  
            System.out.println("Base64.decodeForJS(goToAfterLogin): " + Base64.decodeForJS("QZKnP3K0QYOeK3NWk3NoKUmVKcMhP32WScbop388PxyFK1zVBcb7v3H"));
    }
