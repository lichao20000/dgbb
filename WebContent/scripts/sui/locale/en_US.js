...
if (sui.Calendar) {
    sui.copyTo(sui.Calendar.prototype, {
        firstDayOfWeek: 0,
        todayText: "Today",
        clearText: "Clear",
        okText: "OK",
...
if (sui.FileUpload) {
    sui.FileUpload.prototype.buttonText = "Browse..."
}
if (sui.HtmlFile) {
    sui.HtmlFile.prototype.buttonText = "Browse..."
}
...
if (sui.Pager) {
    sui.copyTo(sui.Pager.prototype, {
        firstText: "First",
        prevText: "Prev",
        nextText: "Next",
        lastText: "Last",
...
-----------------------------------------------------------------------------*/
if (sui.DataGrid) {
    sui.copyTo(sui.DataGrid.prototype, {
...
-----------------------------------------------------------------------------*/
if (window.sui.Gantt) {
    sui.GanttView.ShortWeeks = [
        "Su", "Mo", "Tu", "We", "Th", "Fr", "Sa"
    ];
    sui.GanttView.LongWeeks = [
        "Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"
    ];

    sui.Gantt.PredecessorLinkType = [
