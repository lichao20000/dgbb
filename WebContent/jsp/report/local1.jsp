...
<div id="datagrid1" class="sui-datagrid" 	style="width: 100%; height: 385px" allowResize="true" sortMode="client"
	...
	<div property="columns">
		...
		<div field="send_time" width="120" headeralign="center" allowSort="true" autoEscape="true">发单日期</div>
		<div field="form_title" width="120" align="right" headeralign="center" >工单标题</div>
		<div field="assessment_score" width="120" align="right" headeralign="center" dataType="currency">评分</div>
