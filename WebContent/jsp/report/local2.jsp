...
<!-- 期间选择的通用组件 -->
<form id="excelForm"
	action="${path}/exportExcel.do?method=export&sql=sql90014" method="post"
	target="excelIFrame">
...
<div id="datagrid1" class="sui-datagrid" 	style="width: 100%; height: 385px" allowResize="true" sortMode="client"
	pageSize="100" sizeList="[100,200,500]" 	url="${path}/loadReportData.do?method=loadData&sqlNo=90014" idField="id" onupdate="update"
	...
	-->
		...
		<div field="customer_name" width="50" align="right" headeralign="center">客户名称</div>
		...
		<div field="form_context" width="50" align="right" headeralign="center">工单信息</div>
