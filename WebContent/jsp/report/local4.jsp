...
<!-- 期间选择的通用组件 -->
<form id="excelForm"
	action="${path}/exportExcel.do?method=export&sql=sql90016" method="post"
	target="excelIFrame">
...
<div class="condition">
	...
	<tr>
		...
		<td width="10%" class="tdCondition">
		  ...
		  <td width="5%" class="tdLable"><span style="color: red;">*</span>调单类型：</td>
		   <td width="8%" class="tdCondition">
			<dgcu:XMLDictTagLocal name="customerTypeCode" id="disformType" value="" dictId="disformType" 
					fileName="code" showFlag="DRAFT" field="" />
		</td>
	  </tr>
...
<div id="datagrid1" class="sui-datagrid" 	style="width: 100%; height: 385px" allowResize="true" sortMode="client"
	pageSize="100" sizeList="[100,200,500]" 	url="${path}/loadReportData.do?method=loadData&sqlNo=90016" idField="id" onupdate="update"
	...
	-->
		...
		<div field="form_type" width="50" align="right" headeralign="center">工单类型</div>
		<div field="applicant" width="50" align="right" headeralign="center" ">发单人</div>
		<div field="send_time" width="50" align="right" allowSort="true" headeralign="center">发单时间</div>
		<div field="cust_level" width="50" align="right" headeralign="center">用户级别</div>
		<div field="form_status" width="50" align="right" headeralign="center">工单状态</div>
		<div field="participantname" width="50" headeralign="center" autoEscape="true">处理人</div>
		<div field="bizType" width="50" align="right" headeralign="center">业务类型</div>
		<div field="customer_address" width="50" align="right" headeralign="center" ">详细地址</div>
		<div field="disformType" width="50" align="right" headeralign="center">调单类型</div>
...
function loadData() {
	...
	var customerTypeCode = $("#disformType").val();//获取工单类型
