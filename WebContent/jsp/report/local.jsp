...
<!-- 期间选择的通用组件 -->
<form id="excelForm"
	action="${path}/exportExcel.do?method=export&sql=sql90013" method="post"
	target="excelIFrame">
	...
	<tr>
		...
		<td width="10%" class="tdCondition">
		  ...
		  <td width="5%" class="tdLable"><span style="color: red;">*</span>电路性质：</td>
		   <td width="8%" class="tdCondition">
			<dgcu:XMLDictTagLocal name="customerTypeCode" id="customerType" value="" dictId="customerType" 
					fileName="code" showFlag="DRAFT" field="" />
		</td>
	  </tr>
...
<div id="datagrid1" class="sui-datagrid" 	style="width: 100%; height: 385px" allowResize="true" sortMode="client"
	pageSize="100" sizeList="[100,200,500]" 	url="${path}/loadReportData.do?method=loadData&sqlNo=90013" idField="id" onupdate="update"
	...
	-->
		<div field="form_no" width="80" align="center" name="localCode" allowSort="true"	headeralign="center">调单号</div>
		<div field="form_title" width="80" headeralign="center" autoEscape="true">调单名称</div>
		<div field="bss_customer_name" width="50" align="right" headeralign="center">客户名称</div>
		<div field="applicant" width="50" align="right" headeralign="center" ">申请人</div>
		<div field="biztype" width="50" align="right" headeralign="center">业务类型</div>
		<div field="customertype" width="50" align="right" headeralign="center">电路性质</div>
		<div field="ciruit_no" width="50" headeralign="center" autoEscape="true">电路编号</div>
		<div field="wire_speed" width="50" align="right" headeralign="center">链路带宽</div>
		<div field="wire_speed_unit" width="50" align="right" headeralign="center" ">链路带宽单位</div>
		<div field="bporta_type" width="50" align="right" headeralign="center">A端机房</div>
		<div field="portb_type" width="50" align="right" headeralign="center">Z端机房</div>
		<div field="other_resource" width="50" headeralign="center" autoEscape="true">其他信息</div>
		<div field="trans_resource_circuit" width="50" align="right" headeralign="center">传输端口(电路)</div>
		<div field="trans_resource" width="50" align="right" headeralign="center" ">传输端口</div>
		<div field="switch_resource" width="50" align="right" headeralign="center">交换端口</div>
		<div field="data_resource" width="50" align="right" headeralign="center">数据端口</div>
		
		<div field="disform_desc" width="50" align="right" headeralign="center">工单信息</div>
		<div field="bss_product_no" width="50" align="right" headeralign="center" ">产品号码</div>
		<div field="customer_address" width="50" align="right" headeralign="center">用户地址</div>
		<div field="customer_contact" width="50" align="right" headeralign="center">联系方式</div>
...
<br>
<h1><strong>"调单号"菜单，可以点击进行升序降序排列。</strong></h1>
</body>
</html>