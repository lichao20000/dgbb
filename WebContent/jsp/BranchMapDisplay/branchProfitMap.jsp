...
<body>
    ...
    <div style="margin-left:1%;" >
    	<div style="padding-top:1%;background-image:url(../../images/u72_table.png); background-repeat: no-repeat;height:268px;" >
            <span style="padding-left:5px;"><img alt="利润预算完成率块状图" src="../../images/u96_original.png" width="490px" height="230"px;></span>
            <span style="margin-left:12px;"><img alt="利润预算完成率柱状图" src="../../images/u337_original.png" width="470px" height="230"px;> </span>
        </div>
