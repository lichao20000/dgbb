...
<%@page import="com.dglt.bb.pojo.WKipConfigV"%><html xmlns="http://www.w3.org/1999/xhtml">
			...
			function(e){
				...
				var grid = sui.get("clients");
			      grid.on("load", function () {
			    	  grid.mergeColumns(["qufen_name", "quyu_name","sp_name","client_name"]);
			     });
			     initPage();
			}
		);
		...
		//将label解析成label中的值传递给后台
		 ...
		 if(obj==null||obj==''){ 
			    clearDiv("2GLine","myChartId1");
				  ...
				  lineName=obj[label].busiScName;
				  bizcs =   obj[label].busiSccode;
				 }
...
<form id="excelForm"
    ...
    <div  class="condition"  >
        ...
        <font  class="font1">专业:&nbsp;<input id="profess" name="profess" showNullItem="true" nullItemText="全部（专业）"
        ...
        <font  class="font1">客户:&nbsp;<input id="Client" name="Client" showNullItem="true" nullItemText="全部（客户）"
        ...
        <font class="font1">产品:&nbsp;<input width="150"  id="Product" showNullItem="true" nullItemText="全部（产品）" 
  ...
  <div style="widh:100% ;" >
    	...
    	<div class="div6"></div>
            <div id="clients" class="sui-datagrid" style="width:100%;height:200px" allowAlternating="true"
